...
{#snippet navLinks()}
  <ul class="flex list-none flex-col space-y-1 p-2 md:flex-row md:space-x-1 md:space-y-0 md:p-0">
...
<nav class="relative w-full bg-white px-2 shadow-md dark:bg-slate-800 sm:px-4">
    ...
    <div class="flex items-center gap-2">
      ...
      >
        {#if mode.current === 'light'}
          <svg class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor"><path d="M10 2a1 1 0 011 1v1a1 1 0 11-2 0V3a1 1 0 011-1zm4 8a4 4 0 11-8 0 4 4 0 018 0zm-.464 4.95l.707.707a1 1 0 001.414-1.414l-.707-.707a1 1 0 00-1.414 1.414zm2.12-10.607a1 1 0 010 1.414l-.707.707a1 1 0 11-1.414-1.414l.707-.707a1 1 0 011.414 0zM17 11a1 1 0 100-2h-1a1 1 0 100 2h1zm-7 4a1 1 0 011 1v1a1 1 0 11-2 0v-1a1 1 0 011-1zM5.05 6.464A1 1 0 106.465 5.05l-.708-.707a1 1 0 00-1.414 1.414l.707.707zm1.414 8.486l-.707.707a1 1 0 01-1.414-1.414l.707-.707a1 1 0 011.414 1.414zM4 11a1 1 0 100-2H3a1 1 0 100 2h1z" /></svg>
        {:else if mode.current === 'dark'}
          <svg class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor"><path d="M17.293 13.293A8 8 0 016.707 2.707a8.001 8.001 0 1010.586 10.586z" /></svg>
        {/if}
      </button>
      ...
      <div class="md:hidden">
        ...
        >
          <svg class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16m-4 6h10" /></svg>
        </button>
      </div>
    </div>
  </div>
  ...
  {#if isMobileMenuOpen}
    <div
      class="absolute left-0 right-0 border-t border-gray-200 bg-white shadow-lg dark:border-slate-700 dark:bg-slate-800 md:hidden"
